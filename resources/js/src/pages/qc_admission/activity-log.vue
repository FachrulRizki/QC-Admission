...
<template>
  <div>
    <!-- Header -->
    <PageHero icon="ri-history-line" badge="Admin · Log Aktivitas" title="Log Aktivitas"
      subtitle="Rekam jejak semua aktivitas pengguna di sistem" color-from="#0EA5E9" color-to="#0369A1" :pills="[
    ...
    <VCard elevation="0" border rounded="xl" class="mb-4">
      <VCardText class="pa-3">
        <VRow dense align="center">
          ...
          <VCol cols="6" sm="2">
            <VSelect v-model="filterModule" :items="MODULE_OPTIONS" item-title="title" item-value="value" label="Modul"
              variant="outlined" density="compact" hide-details rounded="lg" />
          </VCol>
          <VCol cols="6" sm="2">
            <VSelect v-model="filterAction" :items="ACTION_OPTIONS" item-title="title" item-value="value" label="Aksi"
              variant="outlined" density="compact" hide-details rounded="lg" />
          </VCol>
          <VCol cols="6" sm="2">
