...
class QualityControl extends Model
{
    ...
    protected $fillable = [
        ...
        'no_mr', 'no_reg', 'nama_pasien', 'jaminan',
        'status_ket', 'edukasi_kamar', 'durasi_tunggu', 'note',
        'petugas', 'status', 'status_ranap', 'ranap_at',
    ...
    {
        return $this->hasMany(EdukasiLanjutan::class, 'quality_control_id');
    }
}
